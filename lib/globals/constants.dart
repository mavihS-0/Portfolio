...
class MobileConstants extends Constants{
  ...
  Color mediumDarkContentColor = const Color(0xff945858);
  Color bgColor2= const Color(0xff1F1033);
  Color subheadingContentColor = const Color(0xffDFB682);
  Color darkContentColor = const Color(0xff2b124c);
...
class WebConstants extends Constants{
  ...
  Color darkContentColor = const Color(0xff2b124c);
  Color subheadingContentColor = const Color(0xffDFB682);
  Color bgColor2= const Color(0xff091D3A);
